 ...
 *
 * NOTE ON THE ANCHOR: this used to be a bare <a> in a server component, chosen
 * so it needed no client-side JavaScript. It now goes through WhatsAppLink,
 * which is a client component, because a WhatsApp tap is a conversion the Ads
 * account has to hear about. The no-JavaScript property is preserved where it
 * matters — the href, the new tab and the prefilled message are all still plain
 * HTML, and only the conversion ping is lost if scripting is off.
 *
